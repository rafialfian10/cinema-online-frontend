...
function AddMovie() {
  ...
  const onSubmit: SubmitHandler<AddMovieValues> = async (data) => {
    ...
    try {
      ...
      toast.error("Movie failed added!", {
        position: "top-right",
        autoClose: 2000,
        hideProgressBar: false,
        closeOnClick: true,
        ...
        <div className="border-b border-gray-900/10 pb-8">
          <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
            <div className="col-span-full">
              <label htmlFor="title" className="text-base text-[#D2D2D2]">
                Title
              </label>
            ...
            <div className="col-span-full">
              <label htmlFor="category" className="text-base text-[#D2D2D2]">
                Category
              </label>
                      ...
                      >
                        <input
                          ...
                          {...register("category", {
                            required: {
                              value: true,
                              message: errorMessages.category_id,
                            },
                          })}
              ...
              {selectedCategoryId.length === 0 && errors.category ? (
            ...
            <div className="col-span-full">
              <label htmlFor="price" className="text-base text-[#D2D2D2]">
                Price
              </label>
              <div className="relative mt-2 flex items-center">
                <input
            ...
            <div className="col-span-full">
              <label htmlFor="link" className="text-base text-[#D2D2D2]">
                Link
              </label>
              <div className="relative mt-2 flex items-center">
                <input
                  ...
                  autoComplete="off"
                  className="block w-full bg-[#535252] rounded-md border-0 p-1.5 text-[#D2D2D2] shadow-sm ring-2 ring-inset ring-[#D2D2D2] placeholder:text-[#D2D2D2] focus:ring-2 focus:ring-inset focus:ring-[#D2D2D2] sm:text-sm sm:leading-6"
                  {...register("link", { required: errorMessages.link })}
                />
              </div>
              {errors.link ? (
                <p className="mt-1 text-red-500">{errors.link.message}</p>
              ) : (
                ""
              )}
            </div>
            ...
            <div className="col-span-full">
              <label htmlFor="description" className="text-base text-[#D2D2D2]">
                Description
              </label>
              <div className="relative mt-2 flex items-center">
                <textarea
            ...
            <div className="col-span-full">
              <label htmlFor="thumbnail" className="text-base text-[#D2D2D2]">
                Upload Thumbnail
              </label>
            ...
            <div className="col-span-full">
              <label htmlFor="trailer" className="text-base text-[#D2D2D2]">
                Upload Trailer
              </label>
              <div className="relative mt-2 items-center">
                <input
                  ...
                  id="trailer"
                  className="w-full m-0 bg-[#535252] flex-auto rounded-md px-3 py-[0.32rem] transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:border-inherit file:rounded-md file:px-3 file:py-[0.32rem] file:transition file:duration-150 file:[margin-inline-end:0.75rem] focus:outline-none dark:text-[#D2D2D2] dark:file:bg-[#0D0D0D] dark:file:text-[#D2D2D2] ring-2 ring-inset ring-[#D2D2D2]"
                  {...register("trailer", { required: errorMessages.trailer })}
                  accept=".mp4,.mkv,.avi,.wmv"
                />
                {errors.trailer ? (
                  <p className="mt-1 text-red-500">{errors.trailer.message}</p>
                ) : (
                  ""
                )}
                <p
            ...
            <div className="col-span-full">
              <label htmlFor="full_movie" className="text-base text-[#D2D2D2]">
                Upload Full Movie
              </label>
              <div className="relative mt-2 items-center">
                <input
