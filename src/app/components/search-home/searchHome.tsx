        ...
        <div className="w-full">
          <div className="shadow-md rounded-lg bg-[#0D0D0D]">
            <div className="flex items-center rounded-md bg-[#3E3E3E]">
              <div className="pl-2">
                <svg
                  className="w-6 h-6 fill-current text-[#D2D2D2]"
              ...
              <input
                type="text"
                id={id}
                className="w-full rounded-md bg-[#3E3E3E] text-[#D2D2D2] leading-tight focus:outline-none p-2"
            ...
            <div className="text-sm">
              {search === "" ? null : filteredMovies.length > 0 ? (
                filteredMovies.map((movie: any) => (
                  <div
                    className="my-2 p-2 flex justify-start rounded-md cursor-pointer bg-[#3E3E3E] text-[#D2D2D2] hover:text-[#3E3E3E] hover:bg-[#D2D2D2]"
                    key={movie?.id}
                  >
